...
public:
    ...
    // Per Saito–Matsumoto 2008, §3.2 Proposition 2: SFMTGen's k(v) is
    ...
    // slow-path consults this via the abstract Generator API and
    // partitions the output stream into P phases.
    int output_phases() const override { return 128 / L_; }

    // SIMD lane count for the SIMD-aware notprimitive method.  SFMTGen
