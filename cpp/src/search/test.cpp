...
EquidistributionPredicate::EquidistributionPredicate(
...
void EquidistributionPredicate::run(
    SeekIterResult& iter,
    const ITestable& gen,
    int kg, int L) const
{
...
bool EquidistributionPredicate::passed(const SeekIterResult& iter) const {
...
void CollisionFreePredicate::run(
    SeekIterResult& iter,
    const ITestable& gen,
    int kg, int L) const
{
    ...
    // EquidistributionPredicate::run) or fall back to L.
...
TupletsPredicate::TupletsPredicate(
    int d,
    std::vector<int> h,
    double threshold,
    int testtype)
...
bool TupletsPredicate::passed(const SeekIterResult& iter) const {
