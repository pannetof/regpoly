 ...
 * @ingroup core
 *
 * Polymorphic `SearchPredicate` for the seek-search loop. Replaces the
 ...
 *  - runs against a `Recurrence` and writes the relevant subset of
 ...
 *
 * Adding a new test type means writing one `SearchPredicate` subclass and
 ...
 * a `Recurrence`, populate the relevant slots of `SeekIterResult`, and
...
public:
    virtual ~SearchPredicate() = default;
 ...
 * @ingroup core
 */
class EquidistributionPredicate : public SearchPredicate {
public:
    /**
     * @brief Construct an equidistribution test predicate.
     *
     * @param method        Owning equidistribution method (from `EquidistributionMethodRegistry`).
 ...
 * @ingroup core
 */
class CollisionFreePredicate : public SearchPredicate {
public:
 ...
 * @ingroup core
 */
class TupletsPredicate : public SearchPredicate {
public:
    /**
