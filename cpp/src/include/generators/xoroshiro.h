 ...
 * @ingroup core
 */
class XoroshiroGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a XoroshiroGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, r, A, B, C.
     * @param L       Output resolution in bits.
     * @return        A constructed XoroshiroGen as a polymorphic Recurrence pointer.
     ...
     * `[1, w-1]`.
     *
     * @param resolved  ParamBag bag containing the pinned structural axes.
     * @param L         Output resolution in bits.
