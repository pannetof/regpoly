 ...
 * @ingroup core
 *
 * `NiederreiterF2Net` is a concrete `DigitalNet` whose j-th generating
 ...
 * @ingroup core
 */
class NiederreiterF2Net : public DigitalNet {
public:
    /**
     ...
     */
    NiederreiterF2Net(int m, int s_max);

    std::string name() const override { return "NiederreiterF2Net"; }
