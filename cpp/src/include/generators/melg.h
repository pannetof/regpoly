...
/**
 * @file melg.h
 * @brief Maximally Equidistributed Long-period Recurrence (Harase & Kimoto 2018).
 *
 ...
 * @ingroup core
 */
class MELGGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a MELGGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, N, M, r, sigma1, sigma2, a.
     * @param L       Output resolution in bits.
     * @return        A constructed MELGGen as a polymorphic Recurrence pointer.
