 ...
 * @ingroup core
 */
class WELLGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a WELLGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, r, p, m1, m2, m3, matrices.
     * @param L       Output resolution in bits.
     * @return        A constructed WELLGen as a polymorphic Recurrence pointer.
