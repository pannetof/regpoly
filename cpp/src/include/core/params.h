 ...
 *
 * Defines `ParamBag` (the runtime parameter bag) plus three helper
 ...
 * @brief Heterogeneous typed parameter bag passed to factories and registries.
 *
 * `ParamBag` is a runtime container that the YAML loader, factories,
 ...
 * of the value stored here. `ParamBag` itself does not track that
