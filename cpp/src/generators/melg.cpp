...
BitVect MELGGen::raw_output() const {
...
std::unique_ptr<ITestable> MELGGen::copy() const {
...
std::unique_ptr<Recurrence> MELGGen::from_params(const ParamBag& params, int L) {
