...
`packages/regpoly/src/include/core/generator.h`).
"""
...
_FAMILY_ALIASES: dict[str, str] = {
    ...
    "sobol":              "SobolNet",
    "Sobol":              "SobolNet",
    "niederreiter":       "NiederreiterF2Net",
    "Niederreiter":       "NiederreiterF2Net",
    # Pre-rename alias kept for backwards compat with existing YAML +
    # Python callers that use the older `*Gen` suffix.
    "NiederreiterF2Gen":  "NiederreiterF2Net",
}
...
_DIGITAL_NET_FAMILIES = {"SobolNet", "NiederreiterF2Net"}
