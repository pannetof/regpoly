...
/**
 * @brief Construct a concrete `Recurrence` of the given family from `params`.
 *
 ...
 * @param params  Typed parameter bag (see `ParamBag`).
 ...
 * @endcode
 *
 * @see :py:func:`regpoly.core.generator.Recurrence.create`
 */
