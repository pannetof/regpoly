 ...
 * @ingroup core
 */
class TinyMT32Gen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a TinyMT32Gen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys mat1, mat2, tmat.
     * @param L       Output resolution in bits.
     * @return        A constructed TinyMT32Gen as a polymorphic Recurrence pointer.
