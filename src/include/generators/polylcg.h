 ...
 * @ingroup core
 */
class PolyLCGGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a PolyLCGGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys k and poly.
     * @param L       Output resolution in bits.
     * @return        A constructed PolyLCGGen as a polymorphic Recurrence pointer.
