 ...
 * @ingroup core
 */
class RMT64Gen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build an RMT64Gen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys mexp, pos, mata, maskb, maskc.
     * @param L       Output resolution in bits.
     * @return        A constructed RMT64Gen as a polymorphic Recurrence pointer.
