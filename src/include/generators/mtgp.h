 ...
 * @ingroup core
 */
class MTGPGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build an MTGPGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys mexp, pos, sh1, sh2, mask,
     *                tbl, tmp_tbl.
     * @param L       Output resolution in bits.
     * @return        A constructed MTGPGen as a polymorphic Recurrence pointer.
