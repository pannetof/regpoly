 ...
 * @ingroup core
 */
class XoshiroGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a XoshiroGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, r, A, B.
     * @param L       Output resolution in bits.
     * @return        A constructed XoshiroGen as a polymorphic Recurrence pointer.
