 ...
 * @ingroup core
 */
class TGFSRGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a TGFSRGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, r, m, a.
     * @param L       Output resolution in bits.
     * @return        A constructed TGFSRGen as a polymorphic Recurrence pointer.
