 ...
 * @ingroup core
 */
class DSFMTGen : public Recurrence {
public:
    /**
    ...
    /**
     * @brief Build a DSFMTGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys mexp, pos1, sl1, msk1, msk2.
     * @param L       Output resolution in bits.
     * @return        A constructed DSFMTGen as a polymorphic Recurrence pointer.
