...
public:
    ...
    /**
     * @brief Build an MTGen from a ParamBag dict (registry factory hook).
     * @param params  Parameter dict with keys w, r, m, p, a.
     * @param L       Output resolution in bits.
     * @return        A constructed MTGen as a polymorphic Recurrence pointer.
