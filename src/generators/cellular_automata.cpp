...
std::unique_ptr<ITestable> CellularAutomataGen::copy() const {
...
std::unique_ptr<Recurrence> CellularAutomataGen::from_params(
...
CellularAutomataGen::compute_default_test_method(const std::string& test_type) const {
    ...
    return Recurrence::compute_default_test_method(test_type);
}
