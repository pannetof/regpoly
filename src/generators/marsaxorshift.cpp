...
std::unique_ptr<ITestable> MarsaXorshiftGen::copy() const {
...
std::unique_ptr<Recurrence> MarsaXorshiftGen::from_params(const ParamBag& params, int L) {
...
// Common ParameterSpaceEnumerator scaffolding shared by every MarsaXorshift
// subclass.  Subclasses populate axes_/sizes_/total_ from their ctor
// and only need to implement at().
class MarsaXorshiftEnumeratorBase : public ParameterSpaceEnumerator {
public:
...
std::unique_ptr<ParameterSpaceEnumerator> MarsaXorshiftGen::make_enumerator(
