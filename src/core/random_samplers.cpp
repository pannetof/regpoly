...
int64_t fetch_int_param(const std::string& name, const ParamBag& p) {
...
int64_t eval_param_expr(const std::string& expr_in, const ParamBag& params) {
...
bool sample_generic_into(const ParamSpec& spec, ParamBag& params) {
...
bool sample_param_into(const ParamSpec& spec, ParamBag& params, int L) {
