...
``packages/regpoly/src/search/tempering_optimizer.cpp``); Python
still owns:
...
class _RunContext:
    ...
    def __init__(self, opt: TemperingOptimizer, comb) -> None:
        self.opt = opt
        self.comb = comb
        self.L = comb.L
    ...
    def run_once(self, delta: list[int], mse: int,
        ...
        cache = _cpp.TemperingOptimizerCache(self._gens, self._trans_cpp, kg, L)
    ...
    def run_minimize(self) -> OptResult:
        ...
        cache = _cpp.TemperingOptimizerCache(self._gens, self._trans_cpp,
                                      self.comb.k_g, L)
    ...
    def _compute_gaps(self) -> tuple[dict[int, int], int]:
        cache = _cpp.TemperingOptimizerCache(
