...
std::unique_ptr<Generator> TauswortheGen::copy() const {
...
std::unique_ptr<Generator> TauswortheGen::from_params(const Params& params, int L) {
...
std::unique_ptr<GenEnumerator> TauswortheGen::make_enumerator(
