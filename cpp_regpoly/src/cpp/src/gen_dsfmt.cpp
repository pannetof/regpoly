...
dSFMTGen::dSFMTGen(int mexp, int pos1, int sl1,
    ...
    : Generateur(128 * ((mexp - 128) / 104 + 2), L),
      mexp_(mexp),
      N_((mexp - 128) / 104 + 1),
      pos1_(pos1), sl1_(sl1),
...
std::unique_ptr<Generateur> dSFMTGen::copy() const {
...
void dSFMTGen::simd_add_state(const Generateur& other) {
...
std::unique_ptr<Generateur> dSFMTGen::from_params(
