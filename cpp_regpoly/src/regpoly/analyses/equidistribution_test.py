...
class EquidistributionTest(AbstractTest):
    ...
    def _run_lattice(self, C: "Combinaison") -> EquidistributionResults:
    ...
    def _run_notprimitive(self, C: "Combinaison") -> EquidistributionResults:
    ...
    def _run_simd_notprimitive(self, C: "Combinaison") -> EquidistributionResults:
        ...
        result = _cpp.test_me_simd_notprimitive(
            gens, trans,
            C.k_g, C.L, self.L,
            delta_capped, mse_capped,
        )
