...
class LegacyReader:
    ...
    def _read_tausworthe(filename: str, L: int) -> list:
        ...
        for _ in range(n):
            ...
            cpp_gen = _cpp.create_generator("taus", params, L)
            generators.append(Generateur(cpp_gen))
        return generators
    ...
    def _read_tgfsr(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                cpp_gen = _cpp.create_generator("tgfsr", params, L)
                generators.append(Generateur(cpp_gen))
        return generators
    ...
    def _read_mt(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                cpp_gen = _cpp.create_generator("MT", params, L)
                generators.append(Generateur(cpp_gen))
        return generators
    ...
    def _read_genf2w(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                cpp_gen = _cpp.create_generator("genf2w", params, L)
                generators.append(Generateur(cpp_gen))
        return generators
    ...
    def _read_carry(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                cpp_gen = _cpp.create_generator("carry", params, L)
                generators.append(Generateur(cpp_gen))
        return generators
    ...
    def _read_matsumoto(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgens):
                ...
                cpp_gen = _cpp.create_generator("matsumoto", params, L)
                generators.append(Generateur(cpp_gen))
        return generators
            ...
            for _ in range(nbgen):
                ...
                if gen_type == TYPE1:
                    ...
                    for shifts in [(a,b,c), (c,b,a), (-a,-b,-c), (a,-c,-b)]:
                        ...
                        cpp_gen = _cpp.create_generator("marsaxorshift", params, L)
                        generators.append(Generateur(cpp_gen))
