...
# All C++ generator class names exposed by the factory, in their new
# canonical form (-Gen suffix). The factory also accepts the old names
# (PolyLCG, Tausworthe, …) so existing DB rows and YAML continue to
# dispatch — see _FAMILY_ALIASES for the resolution map.
