...
All creation goes through Generator.create() and Transformation().
Legacy file tags (e.g. "polylcg", "taus") are accepted by
Generator.create() which resolves them to C++ class names.
"""
...
class LegacyReader:
    ...
    def _read_polylcg(filename: str, L: int) -> list:
        ...
        for _ in range(n):
            ...
            generators.append(Generator.create("PolyLCG", L, **params))
        return generators
    ...
    def _read_tausworthe(filename: str, L: int) -> list:
        ...
        for _ in range(n):
            ...
            generators.append(Generator.create("Tausworthe", L, **params))
        return generators
    ...
    def _read_tgfsr(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                generators.append(Generator.create("TGFSR", L, **params))
        return generators
    ...
    def _read_mt(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                generators.append(Generator.create("MersenneTwister", L, **params))
        return generators
    ...
    def _read_genf2w(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                generators.append(Generator.create("genf2w", L, **params))
        return generators
    ...
    def _read_carry(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgen):
                ...
                generators.append(Generator.create("Carry2Gen", L, **params))
        return generators
    ...
    def _read_matsumoto(filename: str, L: int) -> list:
        ...
        with open(filename) as f:
            ...
            for _ in range(nbgens):
                ...
                generators.append(Generator.create("MatsumotoGen", L, **params))
        return generators
            ...
            for _ in range(nbgen):
                ...
                if gen_type == TYPE1:
                    ...
                    for shifts in [(a,b,c), (c,b,a), (-a,-b,-c), (a,-c,-b)]:
                        ...
                        generators.append(Generator.create("MarsaXorshiftGen", L, **params))
