...
from regpoly._regpoly_cpp import CombinedF2LinearSource as _CppCombined
...
def _build_combination(*gens):
    """Wrap the given Python Generator objects in a CombinedF2LinearSource."""
    from regpoly import make_combined
    return make_combined(*gens, Lmax=32)
