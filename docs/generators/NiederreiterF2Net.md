# NiederreiterF2Net — Niederreiter digital sequence in $\mathbb{F}_2$

**C++ class:** `NiederreiterF2Net`
**Registered name:** `"NiederreiterF2Net"`
**Aliases:** `niederreiter`, `Niederreiter`, `NiederreiterF2Gen` (legacy)
...
gen = Generator.create("NiederreiterF2Net", L=10, s_max=10)
