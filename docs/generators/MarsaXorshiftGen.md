...
(Historical note: pre-v2 `.dat` files tagged this recurrence with
sub-codes 21..25 to drive sibling-variant expansion in the old parser;
the runtime collapses all five back to `type: 2`.)
