...
nb_execution_excludepatterns = [
    ...
    # The reference/* notebooks are pre-v2 demos kept for narrative
    # value. They predate the hierarchy refactor and still spell the
    # retired `Combination`/`CombinedGenerator` / `add_gen` API; the
    # committed cell outputs render as-is so the narrative is
    # preserved without forcing a rewrite of every cell.
    "**/reference/**",
]
